...
<tileset name="pitcher" tilewidth="16" tileheight="16">
 <image source="pitcher.png" width="144" height="128"/>
 <tile id="0">
  <properties>
   <property name="guided" value="true"/>
   <property name="name" value="arrow"/>
   <property name="velocity" value="0.5"/>
  </properties>
  <animation>
   <frame tileid="27" duration="0"/>
   <frame tileid="32" duration="0"/>
  </animation>
 </tile>
 <tile id="1">
  <properties>
   <property name="guided" value="true"/>
   <property name="name" value="arrow"/>
   <property name="velocity" value="0.7"/>
  </properties>
  <animation>
 ...
 <tile id="3">
  <properties>
   <property name="guided" value="true"/>
   <property name="name" value="arrow"/>
   <property name="velocity" value="1.5"/>
  </properties>
  <animation>
   <frame tileid="54" duration="0"/>
   <frame tileid="59" duration="0"/>
  </animation>
 </tile>
 <tile id="4">
  <properties>
